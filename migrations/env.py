...
so the migrations and the app can never disagree about which database they mean.
"""
...
# ConfigParser treats % as interpolation syntax, and it turns up in URL-encoded
# passwords.
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            # instead, so one set of migrations runs on both databases.
